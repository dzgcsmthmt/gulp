;(function(okay) {
    ...
    Select.prototype.open = function() {
        ...
        //init select
        initSelect.call(this,this.options);
    ...
    function initSelect(selectIndexs,options){
    ...
    function initializeEvents() {
        ...
        $(document).on('tap','.select-close',function(e){
            e.preventDefault();
            close();
        });

        $(document).on('tap','.select-confirm',function(e){
            e.preventDefault();
