    ...
    initData: function(){
        ...
        function createLi(arr){
            ...
            for (var i = 0,len = arr.length; i < len; i++){
                ...
                str += '<div class="desc" data-id=' + item.addressId  + '><div class="' + (addressId == item.addressId ? 'active' : '') + ' em"><span>' + item.userName + '</span><span class="phone">' + item.userPhone + '</span>' + (item.isDefault == 1 ? '<span class="btn btn-sm">默认地址</span>' : '') + '</div>';
